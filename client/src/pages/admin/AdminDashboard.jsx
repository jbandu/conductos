    ...
    <AdminLayout>
      <div className="p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Welcome to the ConductOS administration panel</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">Add IC Member</p>
                <p className="text-sm text-gray-600">Manage IC composition</p>
              </div>
            </a>
